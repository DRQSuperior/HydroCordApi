...
function initializeToasts() {
  injectCSS(`@keyframes HydroCord-fadeIn{0%{opacity:0}100%{opacity:1}}.HydroCord-toast-container{position:absolute;top:0;bottom:0;left:0;right:0;pointer-events:none;display:flex;flex-direction:column-reverse;align-items:flex-end;z-index:999999}.HydroCord-toast{background-color:var(--background-floating);padding:18px;margin-right:10px;margin-bottom:10px;display:flex;flex-direction:column;justify-content:center;gap:14px;align-content:center;pointer-events:all;border-radius:5px;box-shadow:var(--elevation-high);animation:HydroCord-fadeIn .3s;max-width:400px;overflow-wrap:anywhere}.HydroCord-toast-title{font-size:22px;line-height:1}`);
  toastDiv.className = "HydroCord-toast-container";
